...
function statistics_page_handler($page_elements) {
    require_once(dirname(dirname(dirname(__FILE__))) . "/statistics/index.php");
}
...
function users_init() {
	...
	register_page_handler('statistics', 'statistics_page_handler');
	...
	register_action("fbregister", true);
